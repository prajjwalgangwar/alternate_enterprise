      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 sm:py-24 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            >
              {!!(content.about_hero_heading_1 as string) && <><span className="text-white/90">{content.about_hero_heading_1}</span>{' '}</>}
              {!!(content.about_hero_heading_2 as string) && <span className="text-gradient-gold">{content.about_hero_heading_2}</span>}
            </motion.h1>
