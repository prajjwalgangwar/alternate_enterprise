        ...
        <section className="relative py-20 sm:py-24 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            >
              ...
              {content.about_hero_badge as string || 'Our Story'}
            </motion.div>
            ...
            >
              <span className="text-white/90">{content.about_hero_heading_1 as string || 'About'}</span>{' '}
              <span className="text-gradient-gold">{content.about_hero_heading_2 as string || 'Us'}</span>
            </motion.h1>
            ...
            >
              {content.about_hero_description as string || 'Premium luxury tobacco exports with decades of industry expertise and global reach.'}
            </motion.p>
          </div>
        </section>
        )}
