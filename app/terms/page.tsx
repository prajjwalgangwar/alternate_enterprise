  ...
  return (
    <div className="min-h-screen flex flex-col bg-cream">
      ...
      <main className="flex-1">
        {(content.section_terms_visible as string) !== 'false' && (content.terms_hero_heading_1 as string) && (
        <section className="relative py-20 sm:py-24 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            {!!(content.terms_hero_badge as string) && (
            <motion.div
            ...
            >
              {!!(content.terms_hero_heading_1 as string) && <><span className="text-white/90">{content.terms_hero_heading_1}</span>{' '}</>}
              {!!(content.terms_hero_heading_2 as string) && <span className="text-gradient-gold">{content.terms_hero_heading_2}</span>}
            </motion.h1>

            {!!(content.terms_hero_description as string) && (
            <motion.p
            ...
            >
              {content.terms_hero_description}
            </motion.p>
            )}
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            {!!(content.terms_content as string) && (
            <motion.div
        ...
        {(content.section_health_warning_visible as string) !== 'false' && content.terms_health_warning && (
        <section className="bg-premium-dark border-t border-gold/5">
          <div className="max-w-4xl mx-auto px-4 py-8 text-center">
            <p className="text-[9px] text-gray-600 leading-relaxed uppercase tracking-[0.2em]">
              {content.terms_health_warning as string}
            </p>
          </div>
        </section>
        )}
