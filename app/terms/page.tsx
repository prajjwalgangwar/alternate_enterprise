        ...
        <section className="relative py-20 sm:py-24 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            >
              ...
              {content.terms_hero_badge as string || 'Terms'}
            </motion.div>
            ...
            >
              <span className="text-white/90">{content.terms_hero_heading_1 as string || 'Terms of'}</span>{' '}
              <span className="text-gradient-gold">{content.terms_hero_heading_2 as string || 'Service'}</span>
            </motion.h1>
            ...
            >
              {content.terms_hero_description as string || 'Terms and conditions governing the use of our website and services.'}
            </motion.p>
          </div>
        </section>
        )}
